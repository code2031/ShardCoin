...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " shardcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  shardcoin-tx [options] <hex-tx> [commands]  Update hex-encoded shardcoin transaction\n" +
            "or:     shardcoin-tx [options] -create [commands]   Create hex-encoded shardcoin transaction\n" +
            "\n";
