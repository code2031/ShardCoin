# Support for Output Descriptors in ShardCoin

Since ShardCoin v0.17, there is support for Output Descriptors. This is a
...
existing ShardCoin wallets, a convenience function `combo` is
