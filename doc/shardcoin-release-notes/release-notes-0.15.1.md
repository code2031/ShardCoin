ShardCoin version *0.15.1* is now available from:

  <https://download.shardcoin.org/shardcoin-0.15.1/>
...
A number of changes to the way ShardCoin deals with peer connections and invalid blocks
