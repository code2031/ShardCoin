ShardCoin version 0.13.3 is now available from:

  <https://download.shardcoin.org/shardcoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/shardcoin-project/shardcoin/blob/0.13/src/chainparams.cpp#L214).
