...
By default, ShardCoin allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that shardcoin's trustless model works best if you are
