# Fuzzing ShardCoin using libFuzzer

## Quickstart guide

To quickly get started fuzzing ShardCoin using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/shardcoin-project/shardcoin
$ cd shardcoin/
$ ./autogen.sh
...
[`process_message`](https://github.com/shardcoin-project/shardcoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/shardcoin-project/shardcoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/shardcoin-project/shardcoin/tree/master/src/test/fuzz).
...
Every single pull request submitted against the ShardCoin repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make ShardCoin more robust.
...
with certain assembly code from ShardCoin's code. See [developer notes on sanitizers](https://github.com/shardcoin-project/shardcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing ShardCoin using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing ShardCoin using [`afl-fuzz`](https://github.com/google/afl):
