Contributing to ShardCoin
============================

The ShardCoin project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the ShardCoin build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/shardcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to shardcoin-qt
...
The following applies to code changes to the ShardCoin project (and related
projects such as libsecp256k1), and is not to be confused with overall ShardCoin
Network Protocol consensus changes.

Whether a pull request is merged into ShardCoin rests with the project merge
...
Patches that change ShardCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ShardCoin consensus, it must have been
...
The project leader is the release manager for each ShardCoin release.
