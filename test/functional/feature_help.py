...
"""Verify that starting shardcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shardcoin with -h for help text")
        ...
        self.log.info("Start shardcoin with -version for version information")
        ...
        self.log.info("Start shardcoind with -fakearg to make sure it does not start")
